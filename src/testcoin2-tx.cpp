...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Testcoin2 testcoin2-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  testcoin2-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded testcoin2 transaction") + "\n" +
                               "  testcoin2-tx [options] -create [commands]   " + _("Create hex-encoded testcoin2 transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded testcoin2 transaction
