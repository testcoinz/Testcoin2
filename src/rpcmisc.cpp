...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total testcoin2 balance of the wallet\n"
            "  \"obfuscation_balance\": xxxxxx, (numeric) the anonymized testcoin2 balance of the wallet\n"
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in testcoin2/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in testcoin2/kb\n"
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"testcoin2address\"\n"
            "\nReturn information about the given testcoin2 address.\n"
            "\nArguments:\n"
            "1. \"testcoin2address\"     (string, required) The testcoin2 address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"testcoin2address\", (string) The testcoin2 address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: TestCoin2 address and we have full public key:
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are testcoin2 addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) testcoin2 address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"testcoin2address\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"testcoin2address\"  (string, required) The testcoin2 address to use for the signature.\n"
