...
int64_t GetBlockValue(int nHeight)
{
	...
	else if (nHeight <= 14999 && nHeight >= 10000)
	{
        nSubsidy = 40 * COIN;
    }
	else if (nHeight <= 19999 && nHeight >= 15000)
	{
        nSubsidy = 30 * COIN;
    }
	...
	else if (nHeight <= 41599 && nHeight >= 25000)
	{
        nSubsidy = 10 * COIN;
    }
	else if (nHeight >= 41600)
	{
        nSubsidy = 60 * COIN;
    }
    else
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
	...
	else if (nHeight <= 9999 && nHeight >= 7500)
	{
        ret = blockValue * 0.6;
    }
	else if (nHeight <= 12499 && nHeight >= 10000)
	{
        ret = blockValue * 0.65;
    }
	else if (nHeight <= 14999 && nHeight >= 12500)
	{
        ret = blockValue * 0.7;
    }
	else if (nHeight <= 17499 && nHeight >= 15000)
	{
        ret = blockValue * 0.75;
    }
