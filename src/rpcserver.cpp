...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop TestCoin2 server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "TestCoin2 server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Testcoin2 features */
        {"testcoin2", "masternode", &masternode, true, true, false},
        {"testcoin2", "listmasternodes", &listmasternodes, true, true, false},
        {"testcoin2", "getmasternodecount", &getmasternodecount, true, true, false},
        {"testcoin2", "masternodeconnect", &masternodeconnect, true, true, false},
        {"testcoin2", "masternodecurrent", &masternodecurrent, true, true, false},
        {"testcoin2", "masternodedebug", &masternodedebug, true, true, false},
        {"testcoin2", "startmasternode", &startmasternode, true, true, false},
        {"testcoin2", "createmasternodekey", &createmasternodekey, true, true, false},
        {"testcoin2", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"testcoin2", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"testcoin2", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"testcoin2", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"testcoin2", "getmasternodescores", &getmasternodescores, true, true, false},
        {"testcoin2", "mnbudget", &mnbudget, true, true, false},
        {"testcoin2", "preparebudget", &preparebudget, true, true, false},
        {"testcoin2", "submitbudget", &submitbudget, true, true, false},
        {"testcoin2", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"testcoin2", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"testcoin2", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"testcoin2", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"testcoin2", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"testcoin2", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"testcoin2", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"testcoin2", "checkbudgets", &checkbudgets, true, true, false},
        {"testcoin2", "mnsync", &mnsync, true, true, false},
        {"testcoin2", "spork", &spork, true, true, false},
        {"testcoin2", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"testcoin2", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use testcoin2d, or the -server option to testcoin2-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> testcoin2-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:49699/\n";
}
