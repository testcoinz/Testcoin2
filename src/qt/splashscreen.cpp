...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    float fontFactor = 0.85;

    // define text to place
    QString titleText = tr("TestCoin2");
    ...
    QString copyrightTextTestCoin2 = QChar(0xA9) + QString(tr(" 2018 The TestCoin2 developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextTestCoin2);
