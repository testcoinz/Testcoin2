...
/** Utility functions used by the TestCoin2 Qt UI.
 */
namespace GUIUtil
{
...
// Render TestCoin2 addresses in monospace font
...
// Parse "testcoin2:" URI into recipient object, return true on successful parsing
