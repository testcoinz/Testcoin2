                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TestCoin2") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TestCoin2 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and testcoin2: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TestCoin2"), this);
    aboutAction->setStatusTip(tr("Show information about TestCoin2"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TestCoin2"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TestCoin2 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TestCoin2 addresses"));
    ...
    openAction->setStatusTip(tr("Open a TestCoin2: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TestCoin2 help message to get a list with possible TestCoin2 command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TestCoin2 client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TestCoin2 network", "", count));
}
...
{
    QString strTitle = tr("TestCoin2"); // default title
