Contributing to TestCoin2
============================

The TestCoin2 project operates an open contributor model where anyone is
...
The following applies to code changes to the TestCoin2 project, and is not to be
confused with overall TestCoin2 Network Protocol consensus changes.

Whether a pull request is merged into TestCoin2 rests with the project merge
...
Patches that change TestCoin2 consensus rules are considerably more involved than
...
Where a patch set proposes to change the TestCoin2 consensus, it must have been
...
The project leader is the release manager for each TestCoin2 release.
