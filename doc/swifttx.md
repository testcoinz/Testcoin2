...
This mechanism has been integrated into Bitcore-Node-TestCoin2 which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TestCoin2-Project/insight-api-testcoin2#web-socket-api](https://github.com/TestCoin2-Project/insight-api-testcoin2#web-socket-api) 
* API: [https://github.com/TestCoin2-Project/insight-api-testcoin2#swifttx-transactions](https://github.com/TestCoin2-Project/insight-api-testcoin2#swifttx-transactions) 
...
By default, the TestCoin2 daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TestCoin2 daemon:
