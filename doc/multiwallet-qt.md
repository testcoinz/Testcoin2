...
In order to support loading of multiple wallets in testcoin2-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is testcoin2.cpp.
...
Changes to testcoin2.cpp
----------------------
testcoin2.cpp is the entry point into testcoin2-qt, and as such, will require some minor modifications to provide hooks for
