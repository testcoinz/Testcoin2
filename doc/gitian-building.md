...
*Setup instructions for a gitian build of TestCoin2 using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the TestCoin2
...
- [Building TestCoin2](#building-testcoin2)
...
Clone the git repositories for testcoin2 and gitian and then checkout the testcoin2 version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/testcoin2-crypto/testcoin2.git
cd testcoin2
...
Follow the instructions in [doc/release-process.md](release-process.md) in the testcoin2 repository
...
To build TestCoin2 (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the testcoin2 repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/testcoin2/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/testcoin2-crypto/testcoin2
...
For example:
```bash
URL=https://github.com/crowning-/testcoin2.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit testcoin2=${COMMIT} --url testcoin2=${URL} ../testcoin2/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit testcoin2=${COMMIT} --url testcoin2=${URL} ../testcoin2/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit testcoin2=${COMMIT} --url testcoin2=${URL} ../testcoin2/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/testcoin2-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/testcoin2-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/testcoin2-build.assert
```
...
[testcoin2/gitian.sigs](https://github.com/testcoin2-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
